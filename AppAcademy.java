/*
 * Vinícius do Carmo Costa 164064X
*/
...
public class AppAcademy extends JFrame implements ActionListener{
	...
	public AppAcademy() {
		...
		lblNome.setFont(new Font("Aluno", Font.PLAIN, 14));
		...
		lblPeso.setFont(new Font("Aluno", Font.PLAIN, 14));
		lblPeso.setBounds(60, 123, 43, 14);
		contentPane.add(lblPeso);
		
		JLabel lblAltura = new JLabel("Altura");
		lblAltura.setFont(new Font("Aluno", Font.PLAIN, 14));
		lblAltura.setBounds(57, 160, 46, 14);
		contentPane.add(lblAltura);
		
		JLabel lblObjetivo = new JLabel("Objetivo");
		lblObjetivo.setFont(new Font("Aluno", Font.PLAIN, 14));
		...
		txtIdade.setFont(new Font("Aluno", Font.PLAIN, 14));
		txtIdade.setColumns(10);
		txtIdade.setBounds(114, 87, 248, 20);
		contentPane.add(txtIdade);
		
		txtPeso = new JTextField();
		txtPeso.setFont(new Font("Aluno", Font.PLAIN, 14));
		...
		txtObjetivo.setFont(new Font("Aluno", Font.PLAIN, 14));
		...
		btnIncluir.setFont(new Font("Aluno", Font.PLAIN, 14));
		...
		btnLimpar.setFont(new Font("Aluno", Font.PLAIN, 14));
		...
		btnMostrar.setFont(new Font("Aluno", Font.PLAIN, 14));
		...
		btnSair.setFont(new Font("Aluno", Font.PLAIN, 14));
		...
		lblTitulo.setFont(new Font("Aluno", Font.BOLD, 18));
